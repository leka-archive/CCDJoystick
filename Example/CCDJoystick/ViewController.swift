...
class ViewController: UIViewController {
    ...
    @IBOutlet private weak var joystickMove: CCDJoystick!
    @IBOutlet private weak var joystickRotate: CCDJoystick!
    ...
    private func addProgrammatically() {
        // 1. Initialize an instance of `CCDJoystick` using the constructor:
